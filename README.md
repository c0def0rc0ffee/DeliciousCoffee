...
| Molecule | Screensaver that turns real molecules slowly in three dimensions, built in code from their bond lengths and angles and named on screen. Plays a clip rendered from that geometry, or draws every frame live if you would rather keep music playing |
